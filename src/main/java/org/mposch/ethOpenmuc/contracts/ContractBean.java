...
/**
 * Loads a contract that exists in the Blockchain, as specified by the Address parameter
 * @param address
 */
...
/**
 * Loads the Contract located at the address that is contained in the gui textfield. 
 */
...
/**
 * Deploys a new smart contract. The smart contract binayr code is contained on the RecordStorage class, which is auto generated code, 
 * generated by the web3j framework command line tools. The source of this auto generation process is the solidity code itself.
 * 
 ...
 */
	...
	/**
	 * @return if the actual contract is valid or not. 
	 * @throws IOException
	 */
